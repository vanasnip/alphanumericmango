-- Voice Terminal Notification System Database Schema
...
CREATE TABLE IF NOT EXISTS templates (
    ...
    subject TEXT,
    body TEXT NOT NULL,
    variables TEXT DEFAULT '[]', -- JSON as TEXT
...
CREATE TABLE IF NOT EXISTS user_preferences (
    ...
    quiet_hours_start TEXT, -- TIME as TEXT (HH:MM)
    quiet_hours_end TEXT,   -- TIME as TEXT (HH:MM)
